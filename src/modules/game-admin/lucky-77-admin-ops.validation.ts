import { z } from 'zod';
import { AdminRole, Lucky77RoundStatus } from '@/generated/prisma/client';
import { createLucky77ConfigSchema } from './game-admin.validation';
...
export const roundListSchema = z.object({
  query: paginationSchema.extend({
    status: z.nativeEnum(Lucky77RoundStatus).optional(),
...
export const configBodySchema = createLucky77ConfigSchema;
export const configUpdateSchema = z.object({
  params: z.object({ config_id: z.string().trim().cuid() }),
  body: createLucky77ConfigSchema.shape.body,
});
